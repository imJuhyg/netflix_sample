...
트랜지션은 딜레이를 설정하여 언제 애니메이션을 시작할지, 트랜지션 대상 CSS 프로퍼티는 어떤 것인지, 트랜지션을 얼마나 지속할지 등을 설정할 수 있다.  
  
* <b>transition-property</b>: (대상 css 속성, 기본값은 all, 트랜지션 대상이 될 수 없는 CSS프로퍼티도 있음)width, background-color  
* <b>transition-duration</b>: (대상 css 속성의 트랜지션 지속값)2s, 2s (ms, s)  
...
## slider / slider__arrow-left / row__posters
### position: relative  
